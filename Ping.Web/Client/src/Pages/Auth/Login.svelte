...
<div
	class="flex min-h-screen flex-col items-center justify-center gap-6 bg-gray-800">
	<svg
	...
	<form
		class="mx-auto w-full max-w-md rounded bg-white px-10 py-6 shadow"
		on:submit|preventDefault={handle_submit}>
		<h1 class="mt-4 text-center text-3xl font-bold">Welcome Back!</h1>
		<div class="mx-auto mt-6 w-24 border-b-2" />
		{#if $form.errors.general}
			<p class="mt-4 text-red-500">{$form.errors.general[0]}</p>
		{/if}
		<TextInput
			id="email"
			class="mt-4 py-2"
